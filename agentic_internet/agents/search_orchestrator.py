...
class SearchOrchestrator:
    ...
    def setup_default_agents(self, tools: list[Tool], model: Any | None = None):
    ...
    def _get_default_model(self, model_id: str | None = None):
    ...
    def search(self, query: str, agents_to_use: list[str] | None = None,
        ...
        # Execute tasks
        results = self._execute_parallel(tasks) if parallel and len(tasks) > 1 else self._execute_sequential(tasks)
    ...
    async def search_async(self, query: str, agents_to_use: list[str] | None = None) -> dict[str, Any]:
        """
